...
Task 8: is going to be a encode task with encoded.zip file I'll attach this file of course, and inside the encoded.zip file you need to search for students_name.txt file, open the file and the task is the following:Encode students_name.txt file,just the first paragraph. This can be done in any way, with or without a programming language. The text was written in English.
